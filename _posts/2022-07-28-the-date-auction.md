...
the item for the price that was shouted. 
...
There is more to discuss about first and second price auctions. 
If you are interested I highly suggest <a href= "https://www.amazon.com/Auction-Theory-Vijay-Krishna/dp/012426297X">this excellent introduction by Vijay Krishna</a>
...
The object of the auction has their own expectation of bid that they deem to be
...
![Pickiness](/assets/posts/the-date-auction/pickiness.png)

We incorporate this into our reward as:
...
Writing this out in the summed form:

$$\mu_D(x,k,b_\text{min}) = F_2(x)\gamma(k,b_\text{min},\beta_D(x))(x-\beta_{D}(x))$$

Now, the bidder doesn't know a priori the parameters of gamma but he/she might
have an expectation that we can write out as $k \sim N(\mu_k,\sigma_k)$ and
$b_\text{min} \sim N(\mu_b,\sigma_b)$. 
